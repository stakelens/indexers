/*
  ...
  - The values [ETH,RPL,USDC] on the enum `UniswapToken` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "UniswapToken_new" AS ENUM ('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', '0xD33526068D116cE69F19A9ee46F0bd304F21A51f', '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48');
